        ...
        <div class="flex flex-row w-screen mt-2 h-5/6">
            ...
            <div class="w-full h-full ml-2 mr-6">
                <div class="flex flex-row space-x-1 mt-12">
                    <a href="{{url('pending')}}"><button type="submit" class="px-8 py-3 border-2 border-blue-800 rounded-lg text-blue-800 font-extrabold">Pending Orders(1)</button></a>
                    ...
                    <button type="submit" class="px-8 py-3 bg-blue-800 rounded-lg text-white font-extrabold">Processing Orders(1)</button>
                ...
                <div class="flex flex-row w-full h-3/6 border-2 border-blue-800">
                    ...
                    <div class="flex flex-col gap-y-5 w-32 mt-6 mr-4">
                        <button class="py-3 px-2 text-center text-white rounded-lg bg-green-700">Shipped</button>
