            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="name" name="name" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $category->name }}" required
                        autofocus>
                    @error('name')
                ...
                <div>
                    ...
                    <input id="name_ar" name="name_ar" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $category->name_ar }}" required>
                    @error('name_ar')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label for="avatar" class="relative w-14 h-14">
                        <img src="{{ $category->image }}" alt="image" class="rounded-full w-24 h-24">
