...
@section('body')
    <div class="w-full p-10">
        <div class="my-4">
            <a href="{{ route('categories.create') }}" class="p-2 rounded-lg text-white bg-blue-800">Add Category</a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($cats as $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-3"><a href="{{ route('categories.edit', $item->id) }}">
                                        <x-bi-pencil />
                                    </a>
                                    {{-- <a href="http://">
                                    <x-bi-folder />
