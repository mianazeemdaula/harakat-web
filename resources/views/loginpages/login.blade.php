...
<body>
    <div class=" flex flex-row w-screen h-screen">
        ...
        <div class=" flex flex-col justify-center items-center w-6/12 h-full bg-gray-400">
            <h1>LogIn</h1>
            <div class=" mt-6">You don't have Account?<a href="{{ url('shop/reg') }}"
                    class=" font-bold text-blue-600 ml-2">SignUp</a></div>
            @if ($errors->any())
            ...
            <div>
                <form action="{{ url('/login') }}" method="POST" class=" flex flex-col">
                    ...
                    <div class=" flex flex-row"><input type="checkbox" class=" w-6 h-6 mt-6"> <span
                            class=" flex items-end ml-2">Remember me</span></div>
                    <button type="submit"
                        class="text-white py-2 px-44 mt-6 rounded-lg  bg-blue-600 font-bold">Login</button>
                </form>
            </div>
        </div>
    </div>
