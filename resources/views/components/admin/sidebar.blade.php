<div class="w-80 border-r-2 border-gray-200">
    <div class="flex flex-col mt-8 space-y-4">
        ...
        <a href="{{ route('riders.index') }}"><button class="flex flex-row btn">
                ...
                <div class="ml-3">{{ __('label.drivers') }}</div>
            </button></a>
        <a href="{{ url('shops-status/approved') }}"><button class="flex flex-row btn">
                ...
                <div class="ml-3">{{ __('label.merchant') }}</div>
            </button></a>
        <a href="{{ url('users') }}"><button class="flex flex-row btn">
                ...
                <div class="ml-3">{{ __('label.users') }}</div>
            </button></a>
        ...
        <a href="{{ url('app-setting') }}"><button class="flex flex-row btn">
                ...
                <div class="ml-3">{{ __('label.app_settings') }}</div>
            </button></a>
        <a href="{{ url('cities') }}"><button class="flex flex-row btn">
                ...
                <div class="ml-3">{{ __('label.cities') }}</div>
            </button></a>
