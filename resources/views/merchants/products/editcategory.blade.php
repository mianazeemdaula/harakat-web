        ...
        <div class="flex flex-row w-screen mt-2 h-5/6">
            ...
            <div class="w-full m-6">
                <div class="flex justify-between pr-32 pl-12">
                    <h2 class="font-bold">ADD NEW CATEGORY</h2>
                    <a href="{{url('product')}}">
                ...
                <div class="pl-12 flex justify-between items-center pr-32">
                    <div>
                        ...
                        <div class="flex flex-row space-x-2 w-48 h-28">
                            <img src="{{URL::asset('/images/montano.png')}}" alt="logo">
                            <img src="{{URL::asset('/images/edit.png')}}" alt="logo" class="w-6 h-6">
                        </div>
                    </div>
                    <a href="{{url('addproduct')}}"><button class="w-32 h-10 rounded-lg text-white bg-blue-600">submit</button></a>
                </div>
            </div>
        </div>
    </div>
