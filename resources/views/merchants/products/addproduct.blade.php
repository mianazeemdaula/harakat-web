            ...
            <div class="w-full m-6">
                ...
                <div class="grid grid-cols-2 gap-2 justify-items-center p-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Prepaeation Time" class="w-80">
                    </div>
                    <div>
                ...
                <div class="pl-12 flex justify-between items-center pr-32">
                    ...
                    <a href="{{url('addproduct-1')}}"><button class="w-32 h-10 rounded-lg text-white bg-blue-600">submit</button></a>
                </div>
            </div>
        </div>
    </div>
