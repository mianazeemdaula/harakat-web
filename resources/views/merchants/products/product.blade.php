                ...
                <div class="flex space-x-4">
                    <div class="w-3/6">
                        <div class="flex flex-row justify-between items-center p-4 w-5/6 h-2/6 border rounded-lg border-gray-300">
                            <h3 class="font-bold text-2xl">Categories</h3>
                            <a href="{{url('addcategory')}}"><img src="{{URL::asset('/images/plusicon.png')}}" alt="logo" class="w-8 h-8"></a>
                        </div>
                        <div class="p-4 w-5/6 h-5/6 space-y-4 border rounded-lg border-gray-300">
                            ...
                            <div class="flex flex-row justify-between">
                                <h3 class="font-bold text-lg">Russian Cuisine</h3>
                                <div class="flex space-x-4">
                                    <img src="{{URL::asset('/images/minusicon.png')}}" alt="logo" class="w-6 h-6">
                                    <img src="{{URL::asset('/images/edit.png')}}" alt="logo" class="w-6 h-6">
                                </div>
                        ...
                        <div class="mt-4">
                            <h3 class="font-bold text-xl">Categories Are Removed Successfully</h3>
                            <div class="text-red-800 text-xl">Removed action not working.Please remove all sub items then try to remove categories again.</div>
                        </div>
                    </div>
                    <div class="w-3/6">
                        <div class="flex flex-row justify-between items-center p-4 w-5/6 h-2/6 border rounded-lg border-gray-300">
                        ...
                        <div class="p-4 w-5/6 h-5/6 space-y-4 border rounded-lg border-gray-300">
                            <div class="flex flex-row justify-between">
                                <h3 class="font-bold text-lg">Lasange</h3>
                                <div class="flex space-x-4">
                                    <img src="{{URL::asset('/images/minusicon.png')}}" alt="logo" class="w-6 h-6">
                                    <img src="{{URL::asset('/images/edit.png')}}" alt="logo" class="w-6 h-6">
                                </div>
