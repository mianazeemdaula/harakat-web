        ...
        <div class="flex flex-row w-screen mt-2 h-5/6">
            ...
            <div class="w-full m-6">
                ...
                <div class="grid grid-cols-2 gap-2 justify-items-center p-6">
                    ...
                    <div>
                        <h3 class="p-2">Preparation Time</h3>
                        <input type="text" placeholder="Preparation Time" class="w-80">
                    </div>
                    <div>
                ...
                <div class="pl-12 flex justify-between items-center pr-32">
                    ...
                    <div class="grid grid-cols-2 gird-cols-3 gap-2">
                        ...
                        <input type="checkbox" name="" id="" class="w-6 h-6">
                        <a href="{{url('manageoption')}}"><button class="w-44 h-10 rounded-lg text-white bg-blue-600">Manage Addon's</button></a>
