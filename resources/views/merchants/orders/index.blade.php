    ...
    <div class="m-9 w-full">
        <div class="flex flex-row space-x-1 mt-12">
            <a href="{{ url('shop/pending/order/') }}"
                class="px-8 py-3 {{ $status == 'pending' ? 'bg-blue-800 text-white' : 'border-2 border-blue-800 text-blue-800' }} rounded-lg  font-extrabold">Pending
                Orders(1)</a>
            <a href="{{ url('shop/approved/order/') }}"
                class="px-8 py-3 {{ $status == 'approved' ? 'bg-blue-800 text-white' : 'border-2 border-blue-800 text-blue-800' }} rounded-lg  font-extrabold">Approved
                Orders(1)</a>
            <a href="{{ url('shop/processing/order/') }}"
                class="px-8 py-3 {{ $status == 'processing' ? 'bg-blue-800 text-white' : 'border-2 border-blue-800 text-blue-800' }} rounded-lg  font-extrabold">Processing
                Orders(1)</a>
            <a href="{{ url('shop/completed/order/') }}"
                class="px-8 py-3 {{ $status == 'completed' ? 'bg-blue-800 text-white' : 'border-2 border-blue-800 text-blue-800' }} rounded-lg  font-extrabold">Completed
                Orders(1)</a>
            <a href="{{ url('shop/canceled/order/') }}"
                class="px-8 py-3 {{ $status == 'canceled' ? 'bg-blue-800 text-white' : 'border-2 border-blue-800 text-blue-800' }} rounded-lg  font-extrabold">Cancelled
                Orders(1)</a>
        </div>
