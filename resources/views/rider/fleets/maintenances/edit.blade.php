...
@section('body')
    <div class="w-full m-6 pb-4">
        <form method="POST" action="{{ route('vehicles.update', $model->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                    ...
                    <input id="make" name="make" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->make }}" required
                        autofocus>
                    @error('make')
                ...
                <div>
                    ...
                    <input id="model" name="model" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->model }}" required>
                    @error('model')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="year" name="year" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->_year }}" required>
                    @error('year')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="plate_number" name="plate_number" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->plate_number }}"
                        required>
                    @error('plate_number')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input id="cylender" name="cylender" type="text"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->cylender }}" required>
                    @error('cylender')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="licence_issue_date" name="licence_issue_date" type="date"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->licence_issue_date }}"
                        required>
                ...
                <div>
                    ...
                    <input id="licence_expiry_date" name="licence_expiry_date" type="date"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->licence_expiry_date }}"
                        required>
                ...
                <div>
                    ...
                    <input id="vehicle_receive_date" name="vehicle_receive_date" type="date"
                        ...
                        value="{{ $model->vehicle_receive_date }}" required>
                ...
                <div>
                    ...
                    <input id="vehicle_return_date" name="vehicle_return_date" type="date"
                        class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $model->name_ar }}" required>
